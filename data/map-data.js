...
export const buildings = [
  {
    ...
    modelPath: "./assets/models/gedung_biro_indoor.glb"
  },
  {
    id: "perpustakaan-ft",
...
/* =========================================================
   3D / AR MODEL DATABASE - REVISION 25
   Urutan ini dikunci untuk slider 1/7 sampai 7/7.
   path: null = slot sudah disiapkan tetapi file model belum tersedia.
========================================================= */

export const models3D = [
  { id: "biro-outdoor", buildingId: "biro-ft", type: "outdoor", label: "Outdoor", title: "Gedung Biro Fakultas Teknik — Outdoor", path: null },
  { id: "biro-indoor", buildingId: "biro-ft", type: "indoor", label: "Indoor", title: "Gedung Biro Fakultas Teknik — Indoor", path: "./assets/models/gedung_biro_indoor.glb" },
  { id: "perkuliahan-outdoor", buildingId: "perkuliahan-ft", type: "outdoor", label: "Outdoor", title: "Gedung Perkuliahan — Outdoor", path: "./assets/models/gedung_perkuliahan_outdoor.glb" },
  { id: "perkuliahan-indoor", buildingId: "perkuliahan-ft", type: "indoor", label: "Indoor", title: "Gedung Perkuliahan — Indoor", path: null },
  { id: "perpustakaan-indoor", buildingId: "perpustakaan-ft", type: "indoor", label: "Indoor", title: "Perpustakaan — Indoor", path: null },
  { id: "laboratorium-outdoor", buildingId: "laboratorium-ft", type: "outdoor", label: "Outdoor", title: "Gedung Laboratorium — Outdoor", path: null },
  { id: "serbaguna-indoor", buildingId: "serbaguna-ft", type: "indoor", label: "Indoor", title: "Gedung Serbaguna — Indoor", path: null }
];

export function getModelsByBuilding(buildingId) {
  return models3D.filter((model) => model.buildingId === buildingId);
}

export function getModel3DById(id) {
  return models3D.find((model) => model.id === id) || null;
}
