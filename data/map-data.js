...
export const entrances = [
    ...
    /*
       ...
       - Seluruh tujuan lantai 2
       - Seluruh tujuan lantai 3
       - Gedung Laboratorium secara umum
    */
    {
        id: "lab-main-e1",
...
export const mapEdges = [
    ...
    /*
       Karena E_LAB_WEST adalah entrance buntu,
       graph berhenti di sini.
    */
...
/* =========================================================
   FUTURE REAL GPS CALIBRATION
========================================================= */

/*
   Belum diisi karena titik latitude / longitude UISU
   belum kita kalibrasikan dengan denah.
...
export function getEntranceById(id){
...
export function getDefaultModelVariant(buildingId){
...
/* =========================================================
   NAVIGATION ENTRANCE RESOLVER

   INI BAGIAN PENTING UNTUK ENTRANCE BUNTU.
========================================================= */

export function getNavigationEntranceForLocation(
    location
){
